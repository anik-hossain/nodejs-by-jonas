...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYW5pa2hvc3NhaW4iLCJhIjoiY2w3dWVxb2RrMDEwdjQwbXN1YjFrNXUydSJ9.PUIYBvPpJDpe3tUBcS55rw';
  var map = new mapboxgl.Map({
    container: 'map',
    // container ID
    style: 'mapbox://styles/anikhossain/cl7ulry78001a14oy4jdfvu54',
    // style URL
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            (0, _alerts.hideAlert)();
            api = type === 'password' ? 'update-password' : 'update-profile';
            _context.prev = 2;
            _context.next = 5;
            return (0, _axios.default)({
              method: 'PATCH',
              url: "http://localhost:3000/api/v1/users/".concat(api),
              data: data
            });
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourID) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe('pk_test_51LguJoFOslhgrmDurm6sOQIMmsS9vaxImoxGv6NzL8AJ5RccedLgUg4OWNFYLPoP5Jc0PPpwUHZKOWDCBQU9dUUF001yluITx1'); // Call your backend to create the Checkout Session
...
var saveGen = document.querySelector('#save-gen');
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "11350" + '/');
